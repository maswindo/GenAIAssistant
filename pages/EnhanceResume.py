...
#     # Step 1: System role specification
#     system_prompt = "You are an expert recruiter with a focus on enhancing resume clarity."
#
#     # Step 2: Instructions for task
#     task_prompt = (
#         "Your task is to analyze the resume and identify the most impactful improvement that enhances readability, structure, or organization. "
#         "Provide a one-sentence suggestion that highlights an improvement the user may not have thought of, including a concise 'before and after' example if relevant."
#     )
#
#     # Step 3: User-specific content to process
#     user_prompt = (
#         f"Provide the best one-sentence clarity improvement for the following resume text to make it more readable and structured, "
#         f"including a 'before and after' example if it helps illustrate the change:\nResume Text: {resume_text}"
#     )
#
#     # Combine all parts of the prompt together
#     full_prompt = {
#         'system': f"{system_prompt} {task_prompt}",
#         'user': user_prompt
#     }
#
#     # Step 4: Interact with the agent using the combined prompt
#     return interact_with_agent(full_prompt)
#
#
#
#
...
#     # Step 1: System role specification
#     system_prompt = "You are an expert in enhancing resume impact by emphasizing achievements and quantifiable results."
#
#     # Step 2: Instructions for task
#     task_prompt = (
#         "Your focus is to identify key accomplishments and ensure that each achievement is clearly quantified where possible. "
#         "Do not fabricate any information."
#     )
#
#     # Step 3: Scope of work
#     scope_prompt = (
#         "Provide specific changes that enhance the impact, but do not modify the entire resume. Your focus should only be on enhancing the impact of achievements."
#     )
#
#     # Step 4: Output requirements
#     output_requirements = (
#         "Provide the following outputs: \n"
#         "1. The enhanced resume text with impact-focused changes applied. \n"
#         "2. A summary of the changes made, with reasoning for each improvement. \n"
#         "3. Examples of sentences before and after the changes, focusing on how quantifiable results were added."
#     )
#
#     # Step 5: User-specific content to process
#     user_prompt = (
#         f"Enhance the impact of the following resume text by emphasizing achievements and quantifiable results where applicable. "
#         f"Do not fabricate information:\nResume Text: {resume_text}"
#     )
#
#     # Combine all parts of the prompt together
#     full_prompt = {
#         'system': f"{system_prompt} {task_prompt} {scope_prompt} {output_requirements}",
#         'user': user_prompt
#     }
#
#     # Step 6: Interact with the agent using the combined prompt
#     return interact_with_agent(full_prompt)
#
